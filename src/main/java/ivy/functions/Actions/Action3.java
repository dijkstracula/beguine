...
public class Action3<T1, T2, T3, U> implements Function3<T1, T2, T3, Either<ActionException, U>> {
    ...
    private final Function3<T1, T2, T3, U> action;
    private final Optional<Function4<T1, T2, T3, U, Optional<ActionException>>> post;

    public Action3(Optional<Function0<Optional<ActionException>>> pre,
                   Function3<T1, T2, T3, U> f,
                   Optional<Function4<T1, T2, T3, U, Optional<ActionException>>> post) {
        this.pre = pre;
        this.action = f;
        this.post = post;
    }
    ...
    public Either<ActionException, U> apply(T1 t1, T2 t2, T3 t3) {
        ...
        Optional<ActionException> postRes = post.flatMap(f -> f.apply(t1, t2, t3, u));
        if (post.isPresent()) {
