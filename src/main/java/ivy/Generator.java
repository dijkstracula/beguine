 ...
 * by ivy_to_cpp.  Generates a particular protocol's particular (public) action.
 ...
 */
public abstract class Generator<P, T> implements Supplier<T> {
    ...
    protected P protocol; // TODO: wildcard bounds on P?

    private int tmp_ctr;

    // TODO: is there any point in passing in P here?
    public Generator(Random r, P p) {
        ctx = new Context();
        slvr = ctx.mkSolver();
    ...
    private void push() { slvr.push(); }
    private void pop() { slvr.pop(); }
    ...
    protected IvyInt mkInt(String name, int min, int max) {
