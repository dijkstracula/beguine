...
class Accord {
  ...
  class PorterIsolate(a: Arbitrary) extends Protocol(a) {
    ...
    class node_id__iter__t__ivysort extends sorts.Record[node_id__iter__t] {}
    ...
    class nset {
      var repr: mutable.ArraySeq[Int] = null
    }
    ...
    class tcp__endpoint__ivysort extends sorts.Record[tcp__endpoint] {}
    ...
    class msg_t__ivysort extends sorts.Record[msg_t] {}

    var node_id__max: Int = 0
    var protocol__preaccepted: Maps.Map2[Int, txn_t, Boolean] = new Maps.Map2[Int, txn_t, Boolean](node_id, new txn_t__ivysort())
    var protocol__committed: Maps.Map3[Int, txn_t, timestamp, Boolean] = new Maps.Map3[Int, txn_t, timestamp, Boolean](node_id, new txn_t__ivysort(), new timestamp__ivysort())
    var net__queue: Maps.Map2[tcp__endpoint, tcp__endpoint, mutable.ArraySeq[msg_t]] = new Maps.Map2[tcp__endpoint, tcp__endpoint, mutable.ArraySeq[msg_t]](new tcp.endpoint__ivysort(), new tcp.endpoint__ivysort())
    var net__len: Maps.Map2[tcp__endpoint, tcp__endpoint, Int] = new Maps.Map2[tcp__endpoint, tcp__endpoint, Int](new tcp.endpoint__ivysort(), new tcp.endpoint__ivysort())
    ...
    var x: Int = 0
    exported[Int, Unit]("ext:coordinator.clock.tick", ext__coordinator__clock__tick, a.numeric(node_id))
    ...
    def nset__majorities_intersect__impl__cardUpTo(s: nset, b: Int): Int = {
      if (b <= 0) {
        ...
        if (
          nset__majorities_intersect__impl__cardUpTo(s, if (b - 1 > 3) 3 else if (b - 1 < 0) 0 else b - 1) + if (nset__member(b, s)) {
          1
        } else {
          0
        } < 0
        ) 0
        else nset__majorities_intersect__impl__cardUpTo(s, if (b - 1 > 3) 3 else if (b - 1 < 0) 0 else b - 1) +
        if (nset__member(b, s)) {
          1
        } else {
          0
    ...
    def nset__majorities_intersect__impl__cardInterUpTo(s1: nset, s2: nset, b: Int): Int = {
      if (b <= 0) {
        if (nset__member(b, s1) && nset__member(b, s2)) {
          1
        } else {
          0
        }
        ...
        if (
          nset__majorities_intersect__impl__cardInterUpTo(s1, s2, if (b - 1 > 3) 3 else if (b - 1 < 0) 0 else b - 1) + if (nset__member(b, s1) && nset__member(b, s2)) {
          1
        } else {
          0
        } < 0
        ) 0
        else nset__majorities_intersect__impl__cardInterUpTo(s1, s2, if (b - 1 > 3) 3 else if (b - 1 < 0) 0 else b - 1) +
        if (nset__member(b, s1) && nset__member(b, s2)) {
          1
        } else {
          0
    ...
    def option_of_value___value(a: mutable.ArraySeq[Int], i: Byte): Int = {
      a(i)
    }

    def option_of_value___end(a: mutable.ArraySeq[Int]): Byte = {
      a.size
    }
    ...
    def option_of_timestamp___value(a: mutable.ArraySeq[timestamp], i: Byte): timestamp = {
      a(i)
    }

    def option_of_timestamp___end(a: mutable.ArraySeq[timestamp]): Byte = {
      a.size
    }
    ...
    def option_of_txn_t___value(a: mutable.ArraySeq[txn_t], i: Byte): txn_t = {
      a(i)
    }

    def option_of_txn_t___end(a: mutable.ArraySeq[txn_t]): Byte = {
      a.size
    }
    ...
    def ext__node_id__iter__next(x: node_id__iter__t): node_id__iter__t = {
    ...
    def node_it__next(x: node_it__t): node_it__t = {
      var loc__0: Boolean = false
      loc__0 = ext__node_id__is_max(x.val_ident)
      if (loc__0) {
        x = ext__node_it__end
    ...
    def nset__emptyset(): nset = {
      var s: nset = new nset()
      nset__api__impl__repr(s) = ext__nset__api__impl__arr__create(0, 0)
      s
    }
    ...
    def nset__fullset(): nset = {
      ...
      loc__en = loc__0
      while (loc__it < loc__en) {
        nset__api__impl__repr(s) = ext__nset__api__impl__arr__append(nset__api__impl__repr(s), node_id__iter__value(loc__it))
    ...
    def nset__add(s: nset, e: Int): nset = {
      if (!(nset__member(e, s))) {
        var loc__0: Int = 0
        loc__0 = ext__nset__api__impl__arridx__next(nset__api__impl__arr__end(nset__api__impl__repr(s)))
        nset__api__impl__repr(s) = ext__nset__api__impl__arr__resize(nset__api__impl__repr(s), loc__0, e)
      }
      s
    }
    ...
    def option_of_value___create(s: Byte, y: Int): mutable.ArraySeq[Int] = {
      var a: mutable.ArraySeq[Int] = mutable.ArraySeq.empty
      s = mutable.ArraySeq.fill(a)(s)
      a
    }
    ...
    def option_of_timestamp___create(s: Byte, y: timestamp): mutable.ArraySeq[timestamp] = {
      var a: mutable.ArraySeq[timestamp] = mutable.ArraySeq.empty
      s = mutable.ArraySeq.fill(a)(s)
      a
    }
    ...
    def ext__protocol__seqid_is_zero(msg: msg_t): Unit = {
      this.assume(msg.first_proposed_at.seqid == 0)
    ...
    def protocol__handle_preaccepted(self: Int, msg: msg_t, resp: msg_t): Unit = {
      ...
      assertThat("abstract_protocol.ivy", 81, msg.kind == msg_t_kind.preaccept_kind)
      assertThat("abstract_protocol.ivy", 82, resp.kind == msg_t_kind.preaccept_resp_kind)
      var loc__tao: txn_t = new txn_t()
      loc__tao = msg.txn
      ext__protocol__seqid_is_zero(msg)
      assertThat("abstract_protocol.ivy", 100, msg.first_proposed_at == resp.first_proposed_at)
      assertThat("abstract_protocol.ivy", 101, ts_le(resp.first_proposed_at, resp.witnessed_at))
      assertThat("abstract_protocol.ivy", 111, protocol.preaccepted.iterator.forall(Gamma => conflicts_with.iterator.forall(Gamma => protocol__preaccepted(self, Gamma) && conflicts_with(Gamma, loc__tao) implies !(Gamma.ts == loc__tao.ts))))
      assertThat("abstract_protocol.ivy", 117, protocol.preaccepted.iterator.forall(Gamma => conflicts_with.iterator.forall(Gamma => protocol__preaccepted(P, Gamma) && protocol__preaccepted(R, loc__tao) && conflicts_with(Gamma, loc__tao) implies !(Gamma.ts == loc__tao.ts))))
      protocol__preaccepted(self, resp.txn) = true

    }

    def protocol__handle_accepted(self: Int, msg: msg_t): Unit = {
      assertThat("abstract_protocol.ivy", 125, msg.kind == msg_t_kind.accept_kind)
    ...
    def option_of_txn_t___create(s: Byte, y: txn_t): mutable.ArraySeq[txn_t] = {
      var a: mutable.ArraySeq[txn_t] = mutable.ArraySeq.empty
      s = mutable.ArraySeq.fill(a)(s)
      a
    }
    ...
    def ext__coordinator__sock__recv(prm__V0: Int, src: tcp__endpoint, msg: msg_t): Unit = {
      this.assume(net__len(src, coordinator__sock__id(prm__V0)) > 0)
      var loc__thing: mutable.ArraySeq[msg_t] = mutable.ArraySeq.empty
      loc__thing = net__queue(src, coordinator__sock__id(prm__V0))
      this.assume(msg == net__msgvec__value(loc__thing, 0))
          ...
          if (msg.kind == msg_t_kind.accept_kind) {
            ...
            if (msg.kind == msg_t_kind.accept_resp_kind) {
              ...
              if (msg.kind == msg_t_kind.commit_kind) {
                ...
                assertThat("protocol.ivy", 247, false)
              }
            }
          }
        }
