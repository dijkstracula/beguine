...
class Accord {
  ...
  class PorterIsolate(a: Arbitrary) extends Protocol(a) {
    ...
    var net__queue: Maps.Map2[tcp__endpoint, tcp__endpoint, mutable.ArraySeq[msg_t]] = new Maps.Map2[tcp__endpoint, tcp__endpoint, mutable.ArraySeq[msg_t]](new tcp__endpoint__ivysort(), new tcp__endpoint__ivysort())
    var net__len: Maps.Map2[tcp__endpoint, tcp__endpoint, Int] = new Maps.Map2[tcp__endpoint, tcp__endpoint, Int](new tcp__endpoint__ivysort(), new tcp__endpoint__ivysort())
